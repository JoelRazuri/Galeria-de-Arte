function footer (){
    ...
    return (
        ...
        <section class="section">
            <h3 class="h3"><a href="item_1.html" class="link">Samples</a></h3>
            <div class="content-p-2">
                <p class="text-2"><a class="info-2" href="item_1.html">Know us</a></p>
                <p class="text-2"><a class="info-2" href="subitem1_1.html">Previous samples</a></p>
            </div>
        </section>
        <section  class="section">
            <h3 class="h3"><a href="item_2.html" class="link">Press</a></h3>
        </section>
        <section  class="section">
            <h3 class="h3"><a href="item_3.html" class="link">Auctions</a></h3>
        </section>
        <section  class="section">
           <h3 class="h3"><a href="item_4.html" class="link">Contact us</a></h3>
           <div id="section-c">
    ...
    <div id="content-p-3">
        <p class="copyright"><i class="fa-solid fa-copyright"></i> 2022 Ricardo López Galería de Arte. All rights reserved.</p>
    </div>`
    );
}
